    ...
    <div class="container mx-auto px-4">
        ...
        <div class="max-w-6xl mx-auto mb-8">
            <a href="{{ route('bale.jobs') }}" wire:navigate.hover
                class="inline-flex items-center text-sm text-gray-500 hover:text-teal-600 transition-colors">
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                    <div class="flex flex-col md:flex-row md:items-start justify-between gap-6">
                        <div>
                            ...
                            <div class="text-xl text-teal-600 font-medium mb-4">{{ $job['company'] }}</div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                    ...
                    <ul class="space-y-3">
                        @foreach($job['description'] as $desc)
                            <li class="flex items-start gap-3 text-gray-600 leading-relaxed">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                    ...
                    <ul class="space-y-3">
                        @foreach($job['requirements'] as $req)
                            <li class="flex items-start gap-3 text-gray-600 leading-relaxed">
                                <span class="w-1.5 h-1.5 bg-teal-500 rounded-full mt-2.5 shrink-0"></span>
                                <span>{{ $req }}</span>
                            </li>
                        @endforeach
                    </ul>
                ...
                {{-- Documents --}}
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                    <h2 class="text-xl font-bold text-gray-900 mb-6">Required Documents</h2>
                    <ul class="space-y-3">
                        @foreach($job['documents'] as $doc)
                            <li class="flex items-start gap-3 text-gray-600 leading-relaxed">
                                <x-lucide-file-text class="w-5 h-5 text-blue-500 mt-0.5 shrink-0" />
                                <span>{{ $doc }}</span>
                            </li>
                        @endforeach
                    </ul>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 sticky top-32">
                    <h3 class="font-bold text-gray-900 mb-6">Job Overview</h3>

                    <div class="space-y-5">
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 rounded-lg bg-teal-50 flex items-center justify-center shrink-0">
                                <x-lucide-coins class="w-5 h-5 text-teal-600" />
                            </div>
                            <div>
                                <div class="text-sm text-gray-500 mb-1">Salary</div>
                                <div class="font-semibold text-gray-900">Rp. {{ $job['salary'] }}</div>
                            </div>
                        </div>

                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center shrink-0">
                                <x-lucide-tag class="w-5 h-5 text-blue-600" />
                            </div>
                            <div>
                                <div class="text-sm text-gray-500 mb-1">Category</div>
                                <div class="font-semibold text-gray-900">{{ $job['category'] }}</div>
                            </div>
                        </div>
                    ...
                    <div class="border-t border-gray-100 my-6 pt-6">
                        <h4 class="font-bold text-gray-900 mb-4">How to Apply</h4>
                        <div class="space-y-3 text-sm text-gray-600 bg-gray-50 p-4 rounded-xl">
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100">
                        <h4 class="font-bold text-gray-900 mb-2">About {{ $job['company'] }}</h4>
