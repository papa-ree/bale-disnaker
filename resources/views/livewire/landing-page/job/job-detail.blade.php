<div class="min-h-screen bg-gray-50 dark:bg-slate-950 pt-32 pb-20">
    <div class="container mx-auto px-4">
        {{-- Breadcrumb --}}
        <div class="max-w-6xl mx-auto mb-8">
            <a href="{{ route('bale.jobs') }}" wire:navigate.hover
                class="inline-flex items-center text-sm text-gray-500 dark:text-slate-400 hover:text-teal-600 transition-colors">
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                {{-- Header Card --}}
                <div
                    class="bg-white dark:bg-slate-900 rounded-2xl p-8 shadow-sm border border-gray-100 dark:border-slate-800">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-4 text-sm text-gray-600 dark:text-slate-400">
                                <div class="flex items-center gap-1.5">
                                    <x-lucide-map-pin class="w-4 h-4 text-gray-400 dark:text-slate-500" />
                                    {{ $job['location'] }}
                                </div>
                                <div class="flex items-center gap-1.5">
                                    <x-lucide-briefcase class="w-4 h-4 text-gray-400 dark:text-slate-500" />
                                    {{ $job['type'] }}
                                </div>
                                <div class="flex items-center gap-1.5">
                                    <x-lucide-clock class="w-4 h-4 text-gray-400 dark:text-slate-500" />
                ...
                <div
                    ...
                    <ul class="space-y-3">
                        @foreach($job['description'] as $desc)
                            <li class="flex items-start gap-3 text-gray-600 dark:text-slate-400 leading-relaxed">
            ...
            <div class="lg:col-span-1 space-y-6">
                {{-- Job Overview --}}
                <div
                    class="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-slate-800 sticky top-32">
                    ...
                    <div class="space-y-5">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <div class="text-sm text-gray-500 dark:text-slate-500 mb-1">Salary</div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <div class="text-sm text-gray-500 dark:text-slate-500 mb-1">Category</div>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <div class="text-sm text-gray-500 dark:text-slate-500 mb-1">Posted</div>
                    ...
                    <div class="border-t border-gray-100 dark:border-slate-800 my-6 pt-6">
                        <h4 class="font-bold text-gray-900 dark:text-white mb-4">How to Apply</h4>
                        <div
                            class="space-y-3 text-sm text-gray-600 dark:text-slate-400 bg-gray-50 dark:bg-slate-800/50 p-4 rounded-xl">
